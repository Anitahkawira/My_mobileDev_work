...
import com.nashipaechepkurui.tmdbmovieapp.API.ApiInterface;
import com.nashipaechepkurui.tmdbmovieapp.Adapter.MoviesAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<MovieResult> movieResultCall = retrofit.create(ApiInterface.class).getMovies();
